...
- Började med en idé om att tonsätta och dokumentera platser, de jag såg under min sjukskrivning, framförallt
  ...
  namn som refererar till tidpunkter eller platser som fastnat tydligt i minnet hos mig. 
	...
	av läkarbesök. 
		...
		byggt. Jag hade en plan om att kunna styra synten med MIDI\footnone{MODO} från SuperCollider, och att
...
% \lstset{scsymbolstyle=\color[RGB]{0,113,0}, scenvvarstyle=\color[RGB]{147,70,14},
% scclassstyle=\color[RGB]{0,40211}}
	\begin{lstlisting}[style=SuperCollider-IDE, caption=Sequencer-exempel]

//// //// //// Struktur av amplitudtriggad synt: //// //// ////
...
//// //// //// Initiering av synt inklusive styrparametrar: //// //// ////
...
~follow2 = Synth(\demandSynth2, 
  ...
  elektrisitet, som konstant överladdning av synapserna, något böljande. 
