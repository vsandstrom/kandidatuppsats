...
bortglömd offentlig konst. Min ursprungliga idé var att tonsätta de här miljöerna, men jag fann att de
speglade min tillvaro, som likt dessa platser kändes stillaståeende och tidlösa. Idén övergick gradvis till
...
den, och att jag utifrån frågeställningen --\emph{"Hur förhåller sig mitt ljudlandskap till ett associativt
landskap?"}, vidareutveckla en komposition. Det är mellan dessa landskap som jag tänker att en gestalt
skulle förmedlas, en struktur som formats av min komposition men som skulle kunna tillåta för ett mer
associativt, figurativt lyssnande hos åhöraren.
