...
\end{lstlisting}
  ...
  intressanta. Mitt första experiment var att skriva en "destruction-loop"\footnote{destruction-loop}, som
  tömde datastrukturen på innehåll, nollställde varje sample en och en. Jag testade sedan samma teknik, men
