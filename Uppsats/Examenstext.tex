...
perioden, och de kommande veckorna präglades av en väldigt hög energinivå hos mig, delvis på grund av
ett förbättrat fysiskt mående, men också på grund av de starka mediciner jag fick. 

Eftersom det var mitt under Covid19-pandemin var tvungna att stanna på sjukhusavdelningen i en
vecka, med bara varandra och sjukhuspersonal som sällskap. Under denna veckan hade jag ofta
ljudhallucinationer, vilka yttrade sig i att det fanns betydligt fler ljudkällor i rummet än vad det faktiskt
var. Varje gång jag blundade lät det som att det var tjugo personer runt omkring mig som pratade i mun på
varann. Jag drömde även väldigt invecklade och tydliga drömmar under den här perioden. 

Jag ville fånga denna smått maniska extas av febrig energi i ljud, vilket slutligen resulterade i detta
...
offset\footnote{\url{https://en.wikipedia.org/wiki/DC\_bias}}
...
Med denna "disclaimer", vill jag prata om hur jag definierat det liminala i relation till min musik och hur
jag använt det som ett extramusikaliskt \emph{raster}, för att luta musikaliska idéer mot. Det jag
identifierat som en liminal association är, likt Mark Fishers definition av \emph{the Eerie}; "avsaknaden av
närvaro, eller en närvaro där vi inte förväntar oss den". En sådan plats var Huddinge sjukhus, en enorm
betongbyggnad 8 våningar hög, där hela väggsidor var utan fönster. Det såg ut som ett dystopiskt fort som
skulle kunna motstå kärnvapenkrig. 
...
Under min process med den ljudande delen som presenteras i detta arbete hade jag en tydlig idé om att jag
ville arbeta gestaltande. Med det menar jag inte beskrivande, mitt mål har inte varit att återskapa
naturtrogna ljudmiljöer av de platser och scenarion jag presenterat ovan. Jag definierar det gestaltande som
ett sätt att avgränsa uttrycken som ska rymmas i en komposition. Ett begrepp kan vara
ett \emph{raster}, som består av associationer och intryck. 

Ett viktigt karaktärsdrag för den här metoden är att den ska vara avhängig, du ska aldrig behöva följa den
ifall den inte inspirerar eller hjälper. Den behöver heller inte ha en tydlig musikalisk koppling, snarare är
det bra om detta \emph{raster} är fritt från från musikaliska konnotationer. 
...
ett poiesiskt\footnote{Poiesisk, Neutral, Estesisk} perspektiv, utan en tanke på, eller snarare en önskan om att det inte skulle kunna kommuniceras
genom musiken. Jag tänkte att vissa \emph{figurativiseringar} var privata eller för banala för att jag skulle
vara bekväm att visa upp den delen av kompositionen. Det var som styrkan med metoden var snarare att jag kunde
luta mig på den, hur förhåller sig mitt ljudlandskap till ett associativt landskap.
Tanken var att musiken skulle kunna få vara mer lågmäld med vad den gestaltar. En fundering var ifall metoden
då skulle tillåta ett mer \emph{figurativiserande} lyssnande hos åhöraren. 

Kan åhöraren förnimma ett narrativ, eller av är det som förmedlas genom musiken? Jag gjorde ingen undersökning
kring detta , men använde det som en del av mitt ramverk vid kompositionen. Min förväntan var att en
"filtrerad" version, på ett sätt frånkopplad sin källa, min associations värld eller landskap, 
förmedla något liknande. Att lyssnaren kunde förnimma en dess struktur eller 
