...
Begreppet akusmatisk härstammar från Pythagoras\footcite{oxford} och var en teknik som
...
Det såg ut som ett dystopiskt fort från science fiction-film.
...
poiesiskt\footnote{Poiesisk, Neutral, Estesisk} perspektiv, utan en tanke på, eller snarare en önskan om att
...
\printbibliography[heading=subbibliography, title={Litteratur}, nottype=music, nottype=web, nottype=dictionary]
\printbibliography[heading=subbibliography, title={Musik}, type=music]
\printbibliography[heading=subbibliography, title={Uppslagsverk}, type=dictionary]
\printbibliography[heading=subbibliography, title={Webb}, type=web]
\end{document}
