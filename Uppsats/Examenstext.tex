...
klagat över att jag inte haft. Eftersom min vardag bestod av repitition var min impuls att skriva om det jag
såg. Jag hade fattat tycke för de märkliga, bortglömda miljöerna som finns på sjukhus och vårdmottagningar,
som existerade mitt i en plats som aldrig sov, som ständigt var i rörelse, men där dessa miljöerna själva såg
obefolkade och stillastående ut. Som att deras funktionalitet hade gått förlorad. En sådan typ av plats jag
reagerat starkt på var de innergårdar, som anlagda med promenadstråk, icke förvuxna buskar och träd och små
konstellationer av parkmöbler övervuxna med alger, som låg insprängda mellan sjukhusbyggnaderna. Eller
...
stillastående och tidlösa. Projektet började över tid frångå den första idén, för att istället handla om att
dokumentera min egen stillastående vardag. 

När jag började må bättre fann jag att det inte var tid utan ork jag hade saknat tidigare, och det var först
då som jag hade orken att ta mig för att börja arbeta med den här idén. I och med att en förbättring av mitt
mående och ett överskott av ledig tid kunde jag ge mig an att lära mig SuperCollider, ett verktyg som jag
...
10.1080/09298219808570738} François Delalande hittade jag ett uttryck som kunde beskriva min metod. Han
...
Idag benämns motsatsen till den ``absoluta musiken'' som ``programmusik''. Detta härstammar från när
kompositörer skrev musik som skulle gestalta en miljö eller scen, där musiken var det bärande berättande
elementet. Ordet ``programmusik'' härstammar från att programbladet på en sådan konsert var viktigt som bilaga
...
Schaeffer och Trevor Wishart. Hon menar även att den elektroakustiska musiken andra förutsättningar än
...
\emph{Are sounds always referential? Is it possible to hear sound before it has been laden with the associations of culture, history, or society?}
\footnote{Joanna Demers, \emph{Listening Through The Noise, The Aesthetic of Experimental Music} s. 23, New York och Oxford: Oxford University Press, 2010}.
...
repress them}". Wishart är i On Sonic Art\footnote{Trevor Wishart (1996), \emph{On Sonic Art}, Amsterdam:
Harwood} skeptisk till Schaeffers reducerade lyssnade. Wishart menar att ljud aldrig kan vara frånskiljda en
association 
%, och lägger istället bedömningen om ett ljuds associativa, extramusikaliska egenskaper hos
lyssnaren, mottagaren av det musikaliska meddelandet. Wishart använder sig istället begreppe som reella och
...
att bejaka den assiciativa förmågan hos ljud, för att få ett starkare grepp över det man som kompositör vill
förmedla. Han anser att det är nödvändigt för kompositören att ta hänsyn till ljudens förmåga att referera.
