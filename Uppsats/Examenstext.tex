...
stillastående vardag.\linebreak
...
"morfologiska enheters"\footnote{Pierre Schaeffer, \emph{Traité des Objets Musicaux} Paris: Édition du Seuil,
1966}. Det taxonomiska intresserar sig främst om relationerna mellan olika identifierbara ljud och klanger och
hur de utvecklas över tid. I kontrast till det taxonomiska, det empatiska och figurativiserande skiljer sig
just i sin tidsuppfattning av musiken och de tolkar inbördes relationer av ljud. Det empatiska lyssnandet,
till skillnad från taxonomiskt, intresserar sig med att uppfatta musiken horisontellt, det omedelbara
samspelet mellan klanger och hur det får en att känna. Istället för att höra helheten och dess samspel,
insatser och uttoningar, försöker man sätta sig i det emotionella tillståndet som musiken, ögonblick för
ögonblick försätter en i.
...
platserna, blev istället ett projekt om att tonsätta min egen stillastående vardag. \linebreak
...
always referential? 
	...
	Is it possible to hear sound before it has been laden with the associations of % <---- använd
culture, history, or society?													   % <---- bara den

	In short, does the act of listening to electronic music
necessarily involve relating sounds to what is already familiar? If not, how do we make sense of the
	experience of listening to abstract, nonreferential, unrecognizable sounds?\footnote{Joanna Demers,
	\emph{Listening Through The Noise, The Aesthetic of Experimental Music}, New York och Oxford: Oxford University Press, 2010}
\end{quote}
...
ljudobjekt\footnote{Pierre Schaeffer, \emph{Traité des Objets Musicaux} Paris: Édition du Seuil, 1966}, som något ursprunget inte
längre är urskiljbart. Begreppet akusmatisk musik har traditionellt använts för att beskriva den tradition som
Schaeffer teoretiserade kring, och som definieras av att analysera och tolka ljud utan att se objektet som
skapar ljudet, och att man då kan tolka ljudet utifrån dess texturer och kvalitéer snarare än dess förmåga att
berätta något dess källa. Schaeffer myntar uttrycket "reducerat lyssnande" för att beskriva denna
analysmetod, som ska göra lyssnaren fri från ljudets inbyggda associationer. 
Istället ska man se ljudet som det existerar i sin mest avskalade, "rena" form. 
Hon ställer Schaeffers teori kring ljudobjekt mot Trevor Wisharts omtolkning av begreppet. Demers skriver:
"\emph{Wishart feels that it is impossible to separate sounds from their associations, so it is incumbent upon
...
%, och lägger istället bedömningen om ett ljuds associativa, extramusikaliska egenskaper hos lyssnaren, mottagaren av det musikaliska meddelandet
...
typerna av ljud han beskriver, kan verka verklig eller overklig. I hans resonemang är det mer intressant att
bejaka den assiciativa förmågan hos ljud, för att få ett starkare grepp över det man som kompositör vill
förmedla.\linebreak

EXTRAMUSIKALITET!!!\linebreak
...
extramusikaliska och till LIMINALITET\linebreak
...
of Passage} (först utgiven 1909), för att beskriva ett mellantillstånd som uppstår inom ritualer som
utförs i kulturer runt om i världen. Uttrycket är till för hjälpa hans arbete under hans forskning på
ritualer, för att kunna beskriva gemensamma mönster som vanligtvis återfinns i ritualer från alla kulturer. 
Han beskriver två ytterligare stadier, en symbolisk (eller i vissa fall religiösa fall verklig) död och
pånyttfödelse, ett före och ett efter, där det "liminala" är tröskeln mellan de två, där förändringen sker. 
Gennep skriver:
...
I texten "Liminality and Experience" beskriver Arpad Szakolczai etymologin av ordet liminalitet, som sprunget
latinska ordet limen/limit, som betyder tröskel eller gräns\footnote{Arpad Szakolczai, \emph{Liminality and
Experience: Structuring transistory situations and transformative events}, International Political
Anthropology Vol. 2, No. 1, s. 147-148, 2009}. Han förtydligar begreppen pre- och postliminalitet, som en
metaforisk död, separationen från sitt tidigare liv, och en pånyttfödsel, där man återförs till till världen
förändrad av ritualen. 
...
\subsection{Musik som vetenskaplig forskning} ###!!!KAPA DETTA STYCKET!!!###
