...
omtolkning av begreppet; ``Wishart feels that it is impossible to separate sounds from
...
\printbibliography[heading=subbibliography, title={Bilagor}, type=bilaga]
